            ...
            >
                <View style={styles.content}>
                    ...
                    <Text style={styles.subtitulo}>
                        Cadastre sua conta de professor no SODA
                    </Text>

                    <Text style={styles.label}>Perfil de Acesso</Text>

                    <View style={styles.input}>
                        <Text style={styles.inputTexto}>Professor</Text>
                    </View>
                    ...
                    <Text style={styles.label}>Disciplina / Área</Text>

                    <TextInput
                        style={styles.input}
                        placeholder="Ex.: Matemática, Informática..."
                        placeholderTextColor="#78879A"
                        value={disciplina}
