            ...
            >
                <View style={styles.content}>
                    ...
                    <Text style={styles.subtitulo}>
                        Cadastre sua conta de aluno no SODA
                    </Text>

                    <Text style={styles.label}>Perfil de Acesso</Text>

                    <View style={styles.input}>
                        <Text style={styles.inputTexto}>Aluno</Text>
                    </View>
                    ...
                    <Text style={styles.label}>Matrícula acadêmica</Text>
                    ...
                    <Text style={styles.label}>Período / Semestre</Text>
